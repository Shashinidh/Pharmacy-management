...
var findUserByNameControllerFn = async (req, res) => {
  var id = req.query.id;
  var user = await userService.findUserByNameDBService(id);
  if (user) {
...
module.exports = { getDataConntrollerfn, createUserControllerFn,updateUserController,deleteUserController, findUserByNameControllerFn };